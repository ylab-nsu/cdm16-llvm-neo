...
#define stdc_first_leading_zero(x) _Generic((x), \
        ...
        unsigned long long int: stdc_first_leading_zero_ul, \
)(x)
...
#define stdc_first_leading_one(x) _Generic((x), \
        ...
        unsigned long long int: stdc_first_leading_one_ul, \
)(x)
...
#define stdc_first_trailing_zero(x) _Generic((x), \
        ...
        unsigned long long int: stdc_first_trailing_zero_ul, \
)(x)
...
#define stdc_first_trailing_one(x) _Generic((x), \
        ...
        unsigned long long int: stdc_first_trailing_one_ul, \
)(x)
...
#define stdc_count_zeros(x) _Generic((x), \
        ...
        unsigned long long int: stdc_count_zeros_ul, \
)(x)
...
#define stdc_count_ones(x) _Generic((x), \
        ...
        unsigned long long int: stdc_count_ones_ul, \
)(x)
...
#define stdc_has_single_bit(x) _Generic((x), \
        ...
        unsigned long long int: stdc_has_single_bit_ul, \
)(x)
...
#define stdc_bit_width(x) _Generic((x), \
        ...
        unsigned long long int: stdc_bit_width_ul, \
)(x)
...
#define stdc_bit_floor(x) _Generic((x), \
        ...
        unsigned long long int: stdc_bit_floor_ul, \
)(x)
...
#define stdc_bit_ceil(x) _Generic((x), \
        ...
        unsigned long long int: stdc_bit_ceil_ul, \
)(x)
